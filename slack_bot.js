...
controller.hears(['にゃ', 'meow'], 'direct_message,direct_mention,mention', function(bot, message) {
    bot.reply(message,'にゃーん！');
});

controller.hears(['残業', '疲れた', '炎上', 'つらい', '死', '殺'], 'direct_message,direct_mention,mention', function(bot, message) {
